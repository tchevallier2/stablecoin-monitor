...
FILINGS = [
    {
        ...
        "notes": "Launched and live on NYSE Arca as SOEZ. 0.19% management fee (waived on first $5B AUM through May 31, 2026). Staking up to 100% of holdings. Tracks CF Benchmarks Solana Index.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A amendment filed Jun 18, 2026. Proposed ticker MSOL on NYSE Arca. 0.14% fee (lowest in market). Staking via Figment, Galaxy Blockchain Infrastructure, and Coinbase Canada.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-02",
        "notes": "Live on Cboe BZX as QSOL. 0.25% management fee. Staking enabled. Coinbase custody. Filing 10-Qs as of Q1 2026.",
    },
    {
        "issuer": "Osprey Funds",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-02",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. SEC published notice Mar 2026.",
    },
]
