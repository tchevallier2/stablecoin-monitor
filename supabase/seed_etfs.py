...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1/A filed Sep 2025. Withdrawn Nov 28, 2025 via Form RW — underlying SPAC/asset-purchase deal was not completed. Planned listing on Nasdaq. Coinbase & BitGo custody.",
    },
    {
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-04-30",
        "sec_url": "https://www.sec.gov/Archives/edgar/data/2082189/000162828025041000/vaneckjitosoletfs-1.htm",
        "notes": "LST-based Solana ETF holding JitoSOL liquid staking token; staking yield reflected in NAV via auto-compounding. Nasdaq filed 19b-4 rule-change proposal Feb 27, 2026 (Federal Register pub. Mar 20, 2026). Pending SEC decision. Separate from VSOL spot ETF.",
    },
]
