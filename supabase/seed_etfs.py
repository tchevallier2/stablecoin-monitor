...
FILINGS = [
    {
        ...
        "notes": "Approved and live on NYSE Arca as SOEZ. 0.19% management fee. Fee waived on first $5B AUM until May 31, 2026. Includes staking. Originally proposed on Cboe BZX.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A amended Jun 18 & Jul 14, 2026. Proposed ticker MSOL on NYSE Arca. 0.14% fee (lowest in category). Stakes 100% of SOL; 95% of rewards to shareholders, 5% to providers (Figment, Galaxy Blockchain Infrastructure, Coinbase Canada).",
    },
    {
        "issuer": "CoinShares",
