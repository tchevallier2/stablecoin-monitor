...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on NYSE Arca (ticker SOEZ). Includes staking. 0.19% fee waived on first $5B AUM until May 31, 2026. Coinbase custody.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Includes staking. Pending SEC approval.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "S-1/A filed. Withdrew filing Nov 28, 2025 under Rule 477 (structuring deal and asset purchase never completed). Planned listing on Nasdaq. Coinbase & BitGo custody.",
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-04-26",
        "notes": "Launched Dec 15, 2025 on Cboe BZX (ticker QSOL). 0.25% expense ratio. Staking via Galaxy Digital Infrastructure. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
        ...
        "is_new": False,
        "last_verified": "2026-04-26",
        "notes": "S-1 filed. Proposed ticker OSOL on Cboe BZX. Coinbase custody. Separate from REX-Osprey joint filing (SSK). Existing OTC:OSOL trust predates this filing.",
    },
    {
        "issuer": "VanEck",
        "etf_name": "VanEck JitoSOL ETF",
        "ticker_proposed": None,
        "filing_type": "S-1 + 19b-4",
        "status": "filed",
        ...
        "is_new": True,
        "last_verified": "2026-04-26",
        "notes": "LST-based Solana ETF holding JitoSOL liquid staking token. Separate from VSOL spot ETF. Nasdaq filed 19b-4 (proposed rule change) Feb 27, 2026; published Federal Register Mar 20, 2026. SEC review window active; pending decision as of Apr 2026.",
    },
]
