...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "First Solana ETF launched in the U.S. Futures-based (not spot); launched March 20, 2025 on Cboe BZX. Uses CME/Coinbase Derivatives SOL futures. 0.95% expense ratio (rising to 1.15% after June 30, 2026). No staking.",
    },
    {
        "issuer": "Volatility Shares",
        ...
        "is_new": True,
        "last_verified": "2026-04-08",
        "notes": "2x leveraged daily Solana futures ETF. Launched March 20, 2025 alongside SOLZ on Cboe BZX. 1.85% expense ratio. Not a spot ETF; no staking.",
    },
]
