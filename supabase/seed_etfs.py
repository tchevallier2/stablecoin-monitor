...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Aug 22, 2025; S-1/A Oct 31, 2025. LST-based ETF holding JitoSOL (Jito Network liquid staking token); staking rewards compound into NAV. Nasdaq 19b-4 rule change filed ~Mar 20, 2026. Under SEC/Nasdaq review. Separate from VSOL spot ETF.",
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-03-31",
        "notes": "1x futures-based (CME Solana futures, cash-settled). Launched Mar 20, 2025 on Nasdaq. 0.95% management fee (waived to this level until Jun 30, 2026; 1.15% after). No direct SOL holdings.",
    },
    {
        "issuer": "Volatility Shares",
        "etf_name": "Volatility Shares 2x Solana ETF",
        "ticker_proposed": "SOLT",
        "filing_type": "485APOS (2x)",
        "status": "approved",
        "filing_date": "2025-01-17",
        "decision_deadline": None,
        "staking_included": False,
        "is_new": True,
        "last_verified": "2026-03-31",
        "notes": "2x leveraged futures-based (CME Solana futures, cash-settled). Launched Mar 20, 2025 on Nasdaq alongside SOLZ. 0.95% management fee (waived to this level until Jun 30, 2026; 1.15% after). No direct SOL holdings.",
    },
    {
        "issuer": "ProShares",
        "etf_name": "ProShares Short Solana ETF",
        "ticker_proposed": None,
        "filing_type": "485APOS (-1x)",
        "status": "filed",
        "filing_date": "2025-01-17",
        "decision_deadline": None,
        "staking_included": False,
        "is_new": True,
        "last_verified": "2026-03-31",
        "notes": "Inverse (-1x) futures-based Solana ETF. Filed Jan 2025 alongside SLON (2x long, launched Jul 14, 2025) and UltraShort. Still pending as of Mar 2026.",
    },
    {
        "issuer": "ProShares",
        ...
        "is_new": True,
        "last_verified": "2026-03-31",
        "notes": "2x inverse (-2x) futures-based Solana ETF. Filed Jan 2025 alongside SLON (2x long, launched Jul 14, 2025) and Short. Still pending as of Mar 2026.",
    },
]
