...
ETFS = [
    ...
    },
    {
        ...
        "fee_waived": False,
        "staking_enabled": True,
        "commission_current": "5% cap",
        "commission_target": "5% cap",
        "commission_note": "Provider fees capped at 5%; 95% of staking rewards passed to investors",
        "pct_staked": "100%",
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "Launched Jul 28, 2026. Lowest management fee in class at 0.14%. 100% SOL staked via Figment, Galaxy & Coinbase Canada. Custody: BNY Mellon & Coinbase Custody. Provider fees capped at 5%.",
    },
]
...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Launched Jul 28, 2026 on NYSE Arca as MSOL. 0.14% fee (lowest in class). 100% SOL staked via Figment, Galaxy & Coinbase Canada. BNY Mellon & Coinbase Custody. Provider fees capped at 5%.",
    },
    {
        "issuer": "CoinShares",
