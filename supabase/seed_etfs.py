...
ETFS = [
    ...
    },
    {
        ...
        "commission_current": "5%",
        "commission_target": "5%",
        "commission_note": "5% validator fee on staking rewards; 95% of yields distributed to shareholders periodically",
        "pct_staked": "100%",
        "gross_yield": "~7.0%",
        "net_yield": "~6.65%",
        "description": "Launched Jul 28, 2026. Lowest-cost U.S. Solana ETF at 0.14%. Stakes 100% of SOL; distributes 95% of staking yields periodically to shareholders, 5% to institutional validator. Via E*TRADE Capital Management.",
    },
]
...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Includes staking. Launched Jul 28, 2026 on NYSE Arca as MSOL. 0.14% expense ratio — lowest-cost U.S. Solana ETF.",
    },
    {
        "issuer": "CoinShares",
