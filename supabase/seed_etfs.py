...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Launched July 28, 2026 on NYSE Arca as MSOL. 0.14% expense ratio (lowest in category). Staking included; rewards flow largely to shareholders. Tracks CoinDesk Solana Benchmark 4PM NY Settlement Rate.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-08-21",
        "notes": "Futures-based Solana ETF (not spot). Launched March 20, 2025 on Nasdaq. Tracks SOL price via CFTC-regulated futures contracts. 0.95% expense ratio (rising to 1.15% after Jun 30, 2026). No staking.",
    },
    {
        "issuer": "Volatility Shares",
        ...
        "is_new": True,
        "last_verified": "2026-08-21",
        "notes": "2x leveraged futures-based Solana ETF (not spot). Launched March 20, 2025 on Nasdaq. Targets twice the daily return of SOL via actively managed CME Group futures contracts. 1.85% expense ratio. No staking.",
    },
]
