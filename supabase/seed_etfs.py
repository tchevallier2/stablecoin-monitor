...
# ── Live ETFs (data sourced from issuer sites, Jul 20 2026) ──────────
...
ETFS = [
    ...
    },
    {
        ...
        "exp_waiver_note": "Waiver expired Feb 5, 2026; sponsor fee permanently cut to 0.19% and staking commission permanently cut to 7% effective Jun 25, 2026",
        "fee_waived": False,
        "staking_enabled": True,
        "commission_current": "7%",
        "commission_target": "7%",
        "commission_note": "Permanently cut from 23% to 7% effective Jun 25, 2026 (5% reduction in Nov 2025 was a temporary waiver that expired Feb 5, 2026)",
        "pct_staked": "100%",
        "gross_yield": "7.01%",
        "net_yield": "5.63%",
        "description": "Formerly Grayscale Solana Trust; converted to ETF Jan 5, 2026. Sponsor fee 0.19%, staking commission 7% (both permanently cut Jun 25, 2026). Now distributes staking rewards quarterly to shareholders.",
    },
    {
        "ticker": "FSOL",
        "issuer": "Fidelity",
        ...
        "commission_note": "Waiver expired May 18, 2026; now charging 15% staking commission",
        "pct_staked": "N/A",
        "gross_yield": "~7.0%",
        "net_yield": "~7.0%",
        "description": "Launched Nov 18, 2025. Fee waiver expired May 18, 2026; now charging 0.25% expense ratio and 15% staking commission. Stakes up to 100% of SOL; rewards reinvested. % staked not publicly disclosed.",
    },
    {
        "ticker": "VSOL",
        "issuer": "VanEck",
    ...
    },
    {
        ...
        "gross_yield": "~7.0%",
        "net_yield": "N/A",
        "description": "Partners with Marinade Finance for liquid staking. BitGo custody. Stakes 100% of SOL; rewards reinvested into NAV.",
    },
    {
        "ticker": "SSK",
        "issuer": "REX-Osprey",
    ...
    },
    {
        ...
        "commission_current": "N/A",
        "commission_target": "N/A",
        "commission_note": "Staking rewards distributed monthly to shareholders (net of fees); commission not separately disclosed",
        "pct_staked": "~100%",
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "Launched Dec 3, 2025 on NYSE Arca. 0.19% expense ratio. Stakes up to 100% of SOL via Coinbase Crypto. Staking rewards distributed monthly to shareholders net of fees.",
    },
    {
        "ticker": "QSOL",
        ...
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "Launched Dec 15, 2025 on Cboe BZX. 0.25% expense ratio. Stakes substantially all SOL via Galaxy Digital Infrastructure. Coinbase Custody. Tracks Lukka Prime Solana Reference Rate.",
    },
]
...
FILINGS = [
    {
        ...
        "notes": "Approved and live. Launched Dec 3, 2025 on NYSE Arca as SOEZ. 0.19% expense ratio. Staking via Coinbase Crypto; rewards distributed monthly.",
    },
    {
        "issuer": "WisdomTree",
        ...
        "is_new": False,
        "last_verified": "2026-07-20",
        "notes": "S-1 filed Mar 2025. Still pending as of Jul 2026. WisdomTree has expanded tokenized fund ecosystem to Solana but no spot ETF approval confirmed.",
    },
    {
        "issuer": "ProShares",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Includes staking. Still pending as of Jul 2026.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-07-20",
        "notes": "Approved and live. Launched Dec 15, 2025 on Cboe BZX as QSOL. 0.25% expense ratio. Staking via Galaxy Digital Infrastructure. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
        ...
        "is_new": True,
        "last_verified": "2026-07-20",
        "notes": "S-1 filed. Proposed ticker OSOL on Cboe BZX. Coinbase custody. Separate from REX-Osprey joint filing. Note: the original Osprey Solana Trust closed-end fund (2021 vintage) was liquidated Jul 15, 2026; this is a separate new spot ETF filing.",
    },
    {
        "issuer": "VanEck",
        ...
        "is_new": True,
        "last_verified": "2026-07-20",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. SEC review initiated Mar 2026; decision expected mid-2026 but not yet confirmed as of Jul 2026.",
    },
]
