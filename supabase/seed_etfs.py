...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A amendment filed Jun 18, 2026 proposes ticker MSOL on NYSE Arca, 0.14% fee (lowest in class), staking via Figment/Galaxy/Coinbase Canada.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "Withdrew SEC filing Nov 28, 2025 (Form RW). CEO cited crowded US market and incomplete transaction. Plans for Nasdaq listing abandoned.",
    },
    {
