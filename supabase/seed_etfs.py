...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on Cboe BZX. Includes staking (up to 100% SOL). 0.19% fee (waived on first $5B AUM through May 31, 2026).",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026. NYSE Arca certification received Jul 24, 2026. Ticker MSOL, 0.14% fee. Coinbase Custody Trust Co. + BNY Mellon as custodians. Staking: up to 100% SOL, 95% of rewards to shareholders, 5% to providers.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-26",
        "notes": "Launched Dec 15, 2025 on Cboe BZX as QSOL. 0.25% expense ratio. Coinbase custody. Staking via Galaxy. Tracks Lukka Prime Solana Reference Rate.",
    },
    {
        "issuer": "Osprey Funds",
