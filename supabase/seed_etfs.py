...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "NYSE Arca certified approval Jul 24, 2026. Ticker MSOL on NYSE Arca. 0.14% management fee. Stakes up to 100% of SOL via Figment, Galaxy, and Coinbase Canada (5% staking commission). S-1 filed Jan 2026 via E*TRADE Capital Management.",
    },
    {
        "issuer": "CoinShares",
