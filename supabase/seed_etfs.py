...
ETFS = [
    ...
    },
    {
        ...
        "commission_note": "5% promotional rate Nov 5, 2025 – Feb 5, 2026 (waiver expired; fund never hit $1B AUM). Standard rate 23% likely reinstated — verify at etfs.grayscale.com/gsol",
        "pct_staked": "100%",
        "gross_yield": "7.01%",
        "net_yield": "5.63%",
        "description": "Formerly Grayscale Solana Trust; converted to ETF Jan 5, 2026. Staking commission was 23% (standard), reduced to 5% Nov 5, 2025 – Feb 5, 2026 (promotional waiver); post-waiver rate unconfirmed.",
    },
    {
        "ticker": "FSOL",
        "issuer": "Fidelity",
