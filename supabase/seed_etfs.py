...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Live on NYSE Arca as SOEZ. 0.19% expense ratio (waiver expired May 31, 2026). Includes staking.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A amendment filed Jul 14, 2026 (third revision). Proposed ticker MSOL on NYSE Arca. 0.14% management fee. Staking via Coinbase, Figment, and Galaxy Blockchain; 5% provider fee, 95% to trust.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-20",
        "notes": "Live as QSOL on Cboe BZX since Dec 15, 2025. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-20",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. SEC published listing notice Mar 2026; still pending approval.",
    },
]
