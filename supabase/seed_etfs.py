...
ETFS = [
    ...
    },
    {
        ...
        "exp_waiver_note": "Fee waiver expires May 31, 2026",
        "fee_waived": True,
        "staking_enabled": True,
        "commission_current": "N/A",
        "commission_target": "N/A",
        "commission_note": "Commission not separately disclosed; reflected in NAV",
        "pct_staked": "Up to 100%",
        "gross_yield": "~7.0%",
        "net_yield": "~7.0%",
        "description": "Launched Dec 3, 2025. Staking up to 100% of holdings. Coinbase Custody. Fee waived on first $5B through May 31, 2026. 0.19% target expense ratio.",
    },
    {
        "ticker": "QSOL",
        ...
        "commission_current": "N/A",
        "commission_target": "N/A",
        "commission_note": "Via Galaxy Digital Infrastructure; not separately disclosed",
        "pct_staked": "N/A",
        "gross_yield": "~7.0%",
        "net_yield": "N/A",
        "description": "Launched Dec 15, 2025. Staking via Galaxy Digital Infrastructure. Coinbase custody. Lukka Prime Solana Reference Rate.",
    },
]
...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Approved and live on NYSE Arca as SOEZ since Dec 3, 2025. Includes staking up to 100%. Coinbase custody. 0.19% expense ratio; fee waived through May 31, 2026.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Includes staking. S-1/A amendment filed May 20, 2026 adds proposed ticker MSOL on NYSE Arca; BNY Mellon and Coinbase Custody as SOL custodians.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-05-28",
        "notes": "Approved and live on Cboe BZX as QSOL since Dec 15, 2025. Staking via Galaxy Digital Infrastructure. Coinbase custody. 0.25% expense ratio.",
    },
    {
        "issuer": "Osprey Funds",
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-05-28",
        "notes": "LST-based Solana ETF using Jito liquid staking token (JitoSOL). Separate from VSOL spot ETF. Nasdaq filed proposed rule change (SR-NASDAQ-2026-016) on Mar 10, 2026 to list on Nasdaq. SEC decision deadline Jun 18, 2026.",
    },
]
