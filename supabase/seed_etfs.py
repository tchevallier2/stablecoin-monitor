...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on NYSE Arca as SOEZ. 0.19% fee (waived through May 31, 2026 on first $5B AUM). Staking included.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A filed Jun 18, 2026: proposes ticker MSOL on NYSE Arca, 0.14% sponsor fee (lowest among spot SOL ETFs), BNY Mellon + Coinbase Custody (joint). Staking via Figment, Galaxy Blockchain Infrastructure, Coinbase Canada; 95% of rewards to investors.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-06-29",
        "notes": "Launched Dec 15, 2025 on Cboe BZX as QSOL. Staking via Galaxy Digital. Tracks Lukka Prime Solana Reference Rate. Coinbase Custody.",
    },
    {
        "issuer": "Osprey Funds",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-06-29",
        "notes": "LST-based Solana ETF using Jito liquid staking token. SEC published notice Mar 2026. Separate from VSOL spot ETF.",
    },
]
