...
# ── Live ETFs (data sourced from issuer sites, Apr 6 2026) ───────────
...
ETFS = [
    ...
    },
    {
        ...
        "commission_target": "0%",
        "commission_note": "No staking fee; 100% of rewards passed to investors via Marinade Select (BitGo custody)",
        "pct_staked": "100%",
        "gross_yield": "~7.0%",
        "net_yield": "N/A",
        "description": "Partners with Marinade Select for liquid staking. 100% of SOL staked; no staking fee charged.",
    },
    {
        "ticker": "SSK",
        "issuer": "REX-Osprey",
    ...
    },
    {
        ...
        "exp_waiver_note": "Fees waived on first $5B in assets until May 31, 2026",
        "fee_waived": True,
        "staking_enabled": True,
        "commission_current": "N/A",
        "commission_target": "N/A",
        "commission_note": "Staking fees not separately disclosed; reflected in NAV",
        "pct_staked": "~100%",
        "gross_yield": "~7.0%",
        "net_yield": "~7.0%",
        "description": "Launched Dec 2025 on NYSE Arca. Fees waived on first $5B in assets until May 31, 2026 (target 0.19%). Coinbase Custody. Seeks to stake substantially all SOL.",
    },
    {
        "ticker": "QSOL",
        ...
        "gross_yield": "~7.0%",
        "net_yield": "~6.7%",
        "description": "Launched Dec 15, 2025 on Cboe BZX. 0.25% expense ratio. Galaxy Digital Infrastructure as staking provider. Coinbase Custody. Seeks to stake substantially all SOL.",
    },
]
...
FILINGS = [
    {
        ...
        "notes": "Approved and live on NYSE Arca as SOEZ (launched Dec 2025). 0.19% expense ratio; fees waived on first $5B until May 31, 2026. Coinbase Custody.",
    },
    {
        "issuer": "WisdomTree",
        ...
        "is_new": False,
        "last_verified": "2026-04-06",
        "notes": "S-1 filed Mar 2025. No approval news found as of Apr 2026.",
    },
    {
        "issuer": "ProShares",
        ...
        "is_new": False,
        "last_verified": "2026-04-06",
        "notes": "S-1 filed Jun 2025 (spot). Also has live leveraged futures ETF (SLON). No spot approval news found as of Apr 2026.",
    },
    {
        "issuer": "REX-Osprey",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Includes staking. No approval news found as of Apr 2026.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "S-1/A filed. Planned listing on Nasdaq. Coinbase & BitGo custody. No approval news found as of Apr 2026.",
    },
    {
        "issuer": "Invesco Galaxy",
        ...
        "is_new": True,
        "last_verified": "2026-04-06",
        "notes": "Approved and live on Cboe BZX as QSOL (launched Dec 15, 2025). 0.25% expense ratio. Galaxy Digital Infrastructure staking. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
        ...
        "is_new": True,
        "last_verified": "2026-04-06",
        "notes": "S-1 filed. Proposed ticker OSOL on Cboe BZX. Coinbase custody. Separate from REX-Osprey joint filing. No approval news found as of Apr 2026.",
    },
    {
        "issuer": "VanEck",
        ...
        "is_new": True,
        "last_verified": "2026-04-06",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq filed 19b-4; still in SEC review as of Apr 2026.",
    },
]
