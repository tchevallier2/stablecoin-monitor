...
# ── Live ETFs (data sourced from issuer sites / SEC filings, Jun 1 2026) ──────────
...
ETFS = [
    ...
    },
    {
        ...
        "commission_note": "Reverted to 23% after promotional waiver expired Feb 5, 2026 (was 5% from Nov 5, 2025 – Feb 5, 2026)",
        "pct_staked": "100%",
        "gross_yield": "7.01%",
        "net_yield": "~5.05%",
        "description": "Formerly Grayscale Solana Trust; converted to ETF Jan 5, 2026. Staking commission reverted to 23% after promotional waiver expired Feb 5, 2026.",
    },
    {
        "ticker": "FSOL",
        "issuer": "Fidelity",
        ...
        "gross_yield": "~7.0%",
        "net_yield": "~5.7%",
        "description": "Launched Nov 18, 2025. 0.25% management fee and 15% staking commission (both waivers expired May 18, 2026). % staked not publicly disclosed.",
    },
    {
        "ticker": "VSOL",
        "issuer": "VanEck",
    ...
    },
    {
        ...
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "REX-Osprey SOL Staking ETF. Launched Jul 2, 2025. Anchorage Digital custody. AUM ~$90M as of Mar 2026.",
    },
    {
        "ticker": "SOEZ",
        ...
        "gross_yield": "~7.0%",
        "net_yield": "N/A",
        "description": "Launched Dec 3, 2025 on NYSE Arca. Stakes up to 100% of SOL. 0.19% expense ratio. Coinbase Custody. Fee waiver on first $5B expired May 31, 2026.",
    },
    {
        "ticker": "QSOL",
        ...
        "commission_target": "3%",
        "commission_note": "3% commission on staking rewards; Galaxy Digital Infrastructure as staking provider",
        "pct_staked": "N/A",
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "Launched Dec 15, 2025 on Cboe BZX. Tracks Lukka Prime Solana Reference Rate. 0.25% expense ratio. 3% staking commission. Coinbase Custody; Galaxy Digital Infrastructure as staking provider.",
    },
]
...
FILINGS = [
    {
        ...
        "notes": "Approved and launched Dec 3, 2025 on NYSE Arca as SOEZ. 0.19% expense ratio. Stakes up to 100% of SOL. Coinbase Custody.",
    },
    {
        "issuer": "WisdomTree",
        ...
        "is_new": False,
        "last_verified": "2026-06-01",
        "notes": "S-1 filed Mar 2025. No approval or withdrawal confirmed as of Jun 2026.",
    },
    {
        "issuer": "ProShares",
        ...
        "is_new": False,
        "last_verified": "2026-06-01",
        "notes": "S-1 filed Jun 2025. Technical amendments submitted. Also has live leveraged futures ETF (SLON). Still pending as of Jun 2026.",
    },
    {
        "issuer": "REX-Osprey",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026; S-1/A (amended) filed May 20, 2026 under ticker MSOL. Includes staking up to 100%. Expected listing on NYSE Arca. Coinbase Custody and BNY Mellon as service providers.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "Withdrawn Dec 1, 2025. Structuring deal and asset purchase supporting the proposed fund were never completed. Planned listing on Nasdaq. Coinbase & BitGo custody.",
    },
    {
        "issuer": "Invesco Galaxy",
        ...
        "is_new": True,
        "last_verified": "2026-06-01",
        "notes": "Approved and launched Dec 15, 2025 on Cboe BZX as QSOL. 0.25% expense ratio. 3% staking commission. Coinbase Custody; Galaxy Digital Infrastructure as staking provider.",
    },
    {
        "issuer": "Osprey Funds",
        ...
        "is_new": True,
        "last_verified": "2026-06-01",
        "notes": "S-1 filed for exchange listing on Cboe BZX. Currently trades OTC as OSOL. Separate from REX-Osprey joint filing (SSK). Coinbase custody.",
    },
    {
        "issuer": "VanEck",
        ...
        "is_new": True,
        "last_verified": "2026-06-01",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Nasdaq filed SR-NASDQ-2026-010 to list the fund. SEC has 45-day review window. Separate from VSOL spot ETF.",
    },
]
