...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on NYSE Arca as SOEZ. 0.19% fee (waived on first $5B AUM through May 31, 2026). Stakes up to 100% of holdings. Lowest fee among Solana ETFs.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026. S-1/A amendment filed May 20, 2026 with proposed ticker MSOL on NYSE Arca. Stakes up to 100% of holdings with monthly distribution. Coinbase Custody + BNY Mellon. $1.8T AUM manager.",
    },
    {
        "issuer": "CoinShares",
