...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on NYSE Arca as SOEZ. 0.19% fee (waived on first $5B AUM through May 31, 2026). Stakes up to 100% of SOL holdings.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-05-07",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq filed 19b-4 rule change Mar 20, 2026 (FR 2026-05475). SEC designated June 18, 2026 as decision deadline (FR 2026-08787, May 6, 2026).",
    },
]
