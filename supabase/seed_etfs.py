...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 2025 on NYSE Arca as SOEZ. 0.19% management fee (waived on first $5B AUM through May 31, 2026). Staking included.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Includes staking. S-1/A amended Jul 14, 2026: proposed ticker MSOL on NYSE Arca, 0.14% sponsor fee (lowest in class), 100% SOL staked via Figment/Galaxy/Coinbase Canada with staking fees capped at 5%. Bloomberg analysts say launch is 'pretty close'.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-24",
        "notes": "S-1 filed. Launched Dec 15, 2025 on Cboe BZX as QSOL. 0.25% expense ratio. Coinbase custody. Tracks Lukka Prime Solana Reference Rate.",
    },
    {
        "issuer": "Osprey Funds",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-21",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq filed 19b-4 to list; still pending SEC approval as of Apr 2026.",
    },
]
