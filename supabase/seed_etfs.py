...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched ~Dec 2025 on NYSE Arca as SOEZ. Includes staking. 0.19% fee; waived on first $5B AUM through May 31, 2026.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026. S-1/A filed Jun 18, 2026. Proposed ticker MSOL on NYSE Arca. Fee: 0.14% (lowest in US market). Staking: 95% of rewards to trust; BNY + Coinbase Custody as custodians. Pending SEC approval.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "S-1/A filed (amendments Jul, Aug, Sep 2025). Form RW (withdrawal) filed Nov 28, 2025. Structuring deal and asset purchase never completed; no securities sold. CoinShares cited US market overcrowding.",
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-14",
        "notes": "Launched Dec 15, 2025 on Cboe BZX as QSOL. Tracks Lukka Prime Solana Reference Rate. No staking. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-14",
        "notes": "S-1 filed Aug 22, 2025. LST-based ETF holding JitoSOL liquid staking token. Proposed listing on Nasdaq. Separate from VSOL spot ETF. SEC issued OIP Jun 23, 2026; still under review.",
    },
]
