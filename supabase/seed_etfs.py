...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026. Second S-1/A amendment filed Jun 18 2026: proposed ticker MSOL on NYSE Arca, 0.14% sponsor fee (lowest in market), 95% of staking rewards passed to investors (5% to providers). Staking via Figment, Galaxy Blockchain Infrastructure, Coinbase Canada.",
    },
    {
        "issuer": "CoinShares",
