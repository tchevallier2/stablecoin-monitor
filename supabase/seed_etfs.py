...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Includes staking. LAUNCHED ~Jul 28 2026 on NYSE Arca as MSOL. 0.14% expense ratio. 95% of staking rewards passed through to shareholders. First US bank-affiliated asset manager to issue a Solana ETF.",
    },
    {
        "issuer": "CoinShares",
