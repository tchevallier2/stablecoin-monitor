...
ETFS = [
    ...
    },
    {
        ...
        "price_usd": None,
        "price_source": "static",
        "exp_ratio_current": "0.95%",
        "exp_ratio_target": "0.95%",
        "exp_waiver_note": None,
        "fee_waived": False,
        ...
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "Futures-based Solana ETF. First US Solana-linked ETF, launched March 20, 2025. Tracks Solana futures contracts; no spot SOL held.",
    },
    {
        "ticker": "SOLT",
        "issuer": "Volatility Shares",
        ...
        "price_usd": None,
        "price_source": "static",
        "exp_ratio_current": "1.85%",
        "exp_ratio_target": "1.85%",
        "exp_waiver_note": None,
        "fee_waived": False,
        "staking_enabled": False,
        "commission_current": "N/A",
        ...
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "2x leveraged Solana futures ETF. Launched March 20, 2025 on Nasdaq. No spot SOL held.",
    },
    {
        "ticker": "SLON",
        "issuer": "ProShares",
        ...
        "price_usd": None,
        "price_source": "static",
        "exp_ratio_current": "2.14%",
        "exp_ratio_target": "2.14%",
        "exp_waiver_note": None,
        "fee_waived": False,
        "staking_enabled": False,
        "commission_current": "N/A",
        ...
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "ProShares Ultra Solana ETF. 2x leveraged Solana futures ETF. Launched July 14, 2025 on NYSE Arca. No spot SOL held. Separate from ProShares pending spot S-1.",
    },
]
...
FILINGS = [
    ...
    {
        "issuer": "ProShares",
        "etf_name": "ProShares Short / UltraShort Solana ETFs",
        "ticker_proposed": None,
        "filing_type": "485A",
        "status": "filed",
        ...
        "notes": "485A filed Jan 17, 2025. Two inverse Solana futures products: Short Solana ETF (-1x) and UltraShort Solana ETF (-2x). Tickers not yet confirmed. Awaiting SEC approval. Separate from live SLON (2x long) and pending spot S-1.",
    },
    {
        "issuer": "Volatility Shares",
        "etf_name": "Volatility Shares Solana ETF / 2x Solana ETF",
        "ticker_proposed": "SOLZ / SOLT",
        "filing_type": "Announced",
        "status": "approved",
        ...
        "is_new": True,
        "last_verified": "2026-04-03",
        "notes": "First US Solana-linked ETFs, both launched March 20, 2025 on Nasdaq. SOLZ: 1x futures (0.95% fee). SOLT: 2x leveraged futures (1.85% fee). No spot SOL held. Now tracked as live ETFs (SOLZ, SOLT) in the ETFS table.",
    },
]
