...
ETFS = [
    ...
    },
    {
        ...
        "exp_ratio_target": "1.15%",
        "exp_waiver_note": "0.95% through June 30, 2026; 1.15% thereafter",
        "fee_waived": False,
        ...
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "First U.S. Solana futures ETF. Launched March 20, 2025. 1x exposure via CME SOL futures (1940 Act registration). Does not hold spot SOL; no staking.",
    },
    {
        "ticker": "SOLT",
        "issuer": "Volatility Shares",
        ...
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "Volatility Shares 2X Solana ETF. Launched March 20, 2025 alongside SOLZ. 2x leveraged daily returns via CME SOL futures (1940 Act). Does not hold spot SOL; no staking.",
    },
]
...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on NYSE Arca as SOEZ. Includes staking. 0.19% expense ratio; fees waived on first $5B AUM through May 31, 2026.",
    },
    {
        "issuer": "WisdomTree",
