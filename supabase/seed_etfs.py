...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "LAUNCHED July 28, 2026 on NYSE Arca as MSOL. 0.14% management fee (lowest among US crypto ETFs at launch). Staking: up to 100% of holdings, 95% of rewards passed through to investors. S-1 filed Jan 2026 via E*TRADE Capital Management.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "S-1/A filed. WITHDRAWN Nov 28, 2025 — CoinShares withdrew Solana, XRP, and Litecoin ETF filings. Cited incomplete underlying transactions; no securities were sold. Pivoting to multi-asset products (DIME ETF).",
    },
    {
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-08-14",
        "notes": "Futures-based ETF (CME Solana futures) — NOT a spot SOL ETF. Listed on Nasdaq. 0.95% fee (waived through Jun 30, 2026, then 1.15%). Volatility Shares also offers SOLT (2x leveraged Solana, 1.85% fee), also live on Nasdaq since Mar 20, 2025.",
    },
]
