...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "Launched July 28, 2026 on NYSE Arca as MSOL. 0.14% expense ratio (lowest-cost Solana ETF on market). Staking up to 100% via Figment, Galaxy Digital, and Coinbase Canada; rewards passed through to investors. S-1 originally filed Jan 2026 via E*TRADE Capital Management.",
    },
    {
        "issuer": "CoinShares",
