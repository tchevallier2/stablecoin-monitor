...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on NYSE Arca as SOEZ. Expense ratio 0.19%; fee waived through May 31, 2026 or first $5B AUM. Staking up to 100%. Coinbase Custody / BNY Mellon admin. (See ETFS list for live fund data.)",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 6, 2026 via E*TRADE Capital Management. S-1/A amendment filed May 20, 2026: proposed ticker MSOL on NYSE Arca. Staking up to 100% through third-party providers; rewards flow back into NAV monthly. Custodians: Coinbase Custody and BNY Mellon. Benchmark: CoinDesk Solana Benchmark 4 p.m. NY Settlement Rate.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "S-1/A filed (last amendment Sep 26, 2025). CoinShares withdrew its US Solana ETF application. Planned listing was Nasdaq; Coinbase & BitGo custody. CoinShares remains active in European SOL staking ETP market.",
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-05-27",
        "notes": "Launched Dec 15, 2025 on Cboe BZX as QSOL. Expense ratio 0.25%. Staking rewards embedded in product structure. Tracks Lukka Prime Solana Reference Rate. Initial launch AUM ~17,500 SOL. (See ETFS list for live fund data.)",
    },
    {
        "issuer": "Osprey Funds",
