...
FILINGS = [
    {
        ...
        "notes": "Now live on NYSE Arca as SOEZ. 0.19% fee (waived on first $5B AUM through May 31, 2026). Tracks CF Benchmarks Solana Index. Includes staking.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026. S-1/A (3rd amendment) filed Jul 14 2026. Proposed ticker MSOL on NYSE Arca. 0.14% annual sponsor fee. Staking up to 100% of SOL (95% to trust, 5% to providers). Coinbase as primary custodian/staking facilitator; BNY Mellon as joint custodian. Bloomberg analyst notes launch is 'getting pretty close' as of Jul 2026.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-15",
        "notes": "Now live on NYSE as QSOL since Dec 15, 2025. Tracks Lukka Prime Solana Reference Rate. Includes staking.",
    },
    {
        "issuer": "Osprey Funds",
    ...
    },
    {
        ...
        "ticker_proposed": None,
        "filing_type": "S-1",
        "status": "sec_proceedings",
        "filing_date": None,
        "decision_deadline": "2026-07-14",
        "staking_included": True,
        "is_new": False,
        "last_verified": "2026-07-15",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq 19b-4 rule change filed Mar 10, 2026 (FR 2026-05475); SEC published notice Mar 20, 2026. OIP proceedings instituted Jun 23, 2026 (FR 2026-12519); public comment deadline Jul 14, 2026 — under formal review, no approval yet.",
    },
]
