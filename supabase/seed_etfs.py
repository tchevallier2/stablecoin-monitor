...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A filed May 20, 2026 adding proposed ticker MSOL (NYSE Arca), 0.14% sponsor fee, detailed staking plan (up to 100% staked, rewards distributed monthly), custodians BNY Mellon + Coinbase Custody.",
    },
    {
        "issuer": "CoinShares",
