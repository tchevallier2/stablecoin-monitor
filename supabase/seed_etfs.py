...
# ── Live ETFs (data sourced from issuer sites, May 11 2026) ──────────
...
ETFS = [
    ...
    },
    {
        ...
        "exp_waiver_note": "Waiver from Oct 9, 2025 through Oct 8, 2026",
        "fee_waived": True,
        "staking_enabled": True,
        "commission_current": "N/A",
        "commission_target": "N/A",
        ...
        "gross_yield": "~7.0%",
        "net_yield": "~6.7%",
        "description": "Distributes staking rewards monthly ($0.016962/share in Mar 2026). 99.77% utilization rate. CME CF Solana-Dollar Reference Rate. Management fee waived through Oct 8, 2026.",
    },
    {
        "ticker": "SOLC",
    ...
    },
    {
        ...
        "commission_current": "N/A",
        "commission_target": "N/A",
        "commission_note": "Monthly distributions; distribution rate ~5.56% as of Mar 27, 2026",
        "pct_staked": "N/A",
        "gross_yield": "~5.6%",
        "net_yield": "~5.1%",
        "description": "REX-Osprey SOL Staking ETF. Anchorage Digital custody. Monthly staking distributions (~5.12% yield, ~5.56% distribution rate as of Mar 2026).",
    },
    {
        "ticker": "SOEZ",
        ...
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "Launched Dec 3, 2025. Stakes up to 100% of SOL. Management fee waived on first $5B AUM through May 31, 2026.",
    },
    {
        "ticker": "QSOL",
        ...
        "commission_target": "3%",
        "commission_note": "3% fee on gross staking rewards via Galaxy Digital Infrastructure",
        "pct_staked": "N/A",
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "Launched Dec 15, 2025. Staking via Galaxy Digital Infrastructure at 3% fee on gross rewards. Tracks Lukka Prime Solana Reference Rate.",
    },
]
...
FILINGS = [
    {
        ...
        "notes": "Approved. Live on NYSE Arca as SOEZ since Dec 3, 2025. 0.19% expense ratio waived on first $5B AUM through May 31, 2026. Stakes up to 100% of SOL.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-05-11",
        "notes": "S-1 filed Jun 2025. Also has live leveraged futures ETF (SLON). Spot filing still pending.",
    },
    {
        "issuer": "REX-Osprey",
    ...
    },
    {
        ...
        "notes": "Withdrawn Nov 28, 2025 via Form RW. Structuring deal and asset purchase not completed; no shares issued. CoinShares also withdrew XRP and Litecoin ETF filings ahead of planned SPAC merger.",
    },
    {
        "issuer": "Invesco Galaxy",
        ...
        "is_new": True,
        "last_verified": "2026-05-11",
        "notes": "Approved. Live on Cboe BZX as QSOL since Dec 15, 2025. 0.25% expense ratio. Staking via Galaxy Digital Infrastructure at 3% fee on gross rewards.",
    },
    {
        "issuer": "Osprey Funds",
        ...
        "is_new": True,
        "last_verified": "2026-05-11",
        "notes": "S-1 filed. Proposed ticker OSOL on Cboe BZX. Coinbase custody. Separate from REX-Osprey joint filing. Currently trading OTC; exchange listing pending.",
    },
    {
        "issuer": "VanEck",
        ...
        "is_new": True,
        "last_verified": "2026-05-11",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq filed 19b-4 rule change (SR-NASDAQ-2026-010) for listing; pending SEC review as of Q2 2026.",
    },
]
