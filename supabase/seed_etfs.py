...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on NYSE Arca as SOEZ. 0.19% expense ratio (waived on first $5B AUM through May 31, 2026). Includes staking up to 100% of assets.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-04-05",
        "notes": "S-1 filed Jun 2025. Launched Dec 15, 2025 on Cboe BZX as QSOL. 0.25% expense ratio. Staking via Galaxy Digital Infrastructure. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
