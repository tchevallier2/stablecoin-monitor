...
FILINGS = [
    ...
    },
    {
        ...
        "sec_url": "https://www.sec.gov/Archives/edgar/data/2103547/000110465926075843/tm2534148d4_s1a.htm",
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A (second amendment) filed Jun 18 2026: proposed ticker MSOL on NYSE Arca, 0.14% sponsor fee (lowest in US market), staking 100% of SOL holdings via Figment/Galaxy/Coinbase Canada (5% fee cap), 95% of staking rewards passed to investors. Still under SEC review.",
    },
    {
        "issuer": "CoinShares",
