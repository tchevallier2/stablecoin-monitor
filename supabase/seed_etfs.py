...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Includes staking (Figment, Galaxy, Coinbase Canada; 5% fee cap). Proposed ticker MSOL on NYSE Arca. 0.14% expense ratio (lowest in category). Form 8-A went auto-effective Jul 24, 2026 — trading pending CERT filing.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-09-06",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq filed to list Jun 2026; SEC instituted proceedings to approve/disapprove Jun 23, 2026.",
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-09-06",
        "notes": "Futures-based Solana ETF using CME SOL futures. Live on NASDAQ since Mar 20, 2025. Expense ratio 1.15% (was 0.95% at launch). 2x leveraged version also live on NASDAQ as SOLT (1.85% expense ratio). Not a spot ETF.",
    },
]
