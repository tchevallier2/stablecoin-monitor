...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Approved and live on NYSE Arca as SOEZ since Dec 3, 2025. 0.19% expense ratio (fee waived on first $5B AUM until May 31, 2026). Includes staking.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1/A filed (Sep 2025). Withdrawn Nov 28, 2025. CoinShares cited consolidation in the single-asset crypto ETF market and pivoted strategy toward crypto equity/thematic products ahead of its planned Nasdaq listing.",
    },
    {
