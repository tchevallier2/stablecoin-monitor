...
ETFS = [
    ...
    },
    {
        ...
        "exp_waiver_note": "Fees waived on first $5B AUM through May 31, 2026 (now expired)",
        "fee_waived": False,
        "staking_enabled": True,
        "commission_current": "N/A",
        "commission_target": "N/A",
        ...
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "Launched December 3, 2025. Tracks CF Benchmarks Solana Index. 0.19% management fee; fee waiver on first $5B AUM expired May 31, 2026. Staking enabled.",
    },
    {
        "ticker": "QSOL",
        ...
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "Launched December 15, 2025. Tracks Lukka Prime Solana Reference Rate. 0.25% expense ratio. Staking via Galaxy Digital Infrastructure. Coinbase Custody.",
    },
]
...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched December 3, 2025 on NYSE Arca. 0.19% management fee. Fee waiver on first $5B AUM expired May 31, 2026. Staking enabled. Tracks CF Benchmarks Solana Index.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A amendment filed Jun 18, 2026. Proposed ticker MSOL on NYSE Arca. 0.14% sponsor fee (lowest in class). 100% of SOL to be staked via Figment, Galaxy, and Coinbase Canada. Pending SEC approval.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-19",
        "notes": "S-1 filed. Launched December 15, 2025 on Cboe BZX. 0.25% expense ratio. Staking via Galaxy Digital Infrastructure. Coinbase custody. Lukka Prime pricing.",
    },
    {
        "issuer": "Osprey Funds",
