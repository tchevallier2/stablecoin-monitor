...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Approved and live on NYSE Arca as SOEZ. Fee: 0.19% (waived on first $5B AUM through May 31, 2026). Includes staking.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Amended S-1 filed Jul 14, 2026. Proposed ticker MSOL on NYSE Arca. Fee: 0.14% (lowest in US SOL ETF market). 100% staking via Figment, Galaxy Blockchain Infrastructure, Coinbase Canada (5% fee cap, 95% rewards to investors). Bloomberg analyst says launch 'pretty close' (Jul 2026).",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-07-16",
        "notes": "Approved and live on Cboe BZX as QSOL (launched Dec 15, 2025). Coinbase custody, Galaxy staking. Tracks Lukka Prime Solana Reference Rate. Stakes substantially all SOL held.",
    },
    {
        "issuer": "Osprey Funds",
