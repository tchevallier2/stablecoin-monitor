...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "NYSE Arca certified listing approval July 24, 2026. Ticker: MSOL on NYSE Arca. 0.14% management fee. Staking: up to 100% of SOL holdings via Figment, Galaxy Blockchain, and Coinbase Canada (service fees capped at 5%); rewards distributed to investors. S-1 originally filed Jan 2026 via E*TRADE Capital Management.",
    },
    {
        "issuer": "CoinShares",
