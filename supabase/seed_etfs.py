...
ETFS = [
    ...
    },
    {
        ...
        "commission_current": "5%",
        "commission_target": "5%",
        "commission_note": "5% of gross staking rewards paid to providers/custodians; 95% flows to fund",
        "pct_staked": "up to 100%",
        "gross_yield": "~7.0%",
        "net_yield": "~6.5%",
        "description": "Launched Jul 28, 2026 on NYSE Arca. Cheapest US Solana ETF at 0.14%. Staking via Figment, Galaxy Digital, and Coinbase Canada (up to 100%). Dual custody: BNY Mellon (primary) + Coinbase. Monthly distributions. Tracks CoinDesk Solana Benchmark 4PM NY Settlement Rate.",
    },
]
...
FILINGS = [
    {
        ...
        "notes": "Live on NYSE Arca as SOEZ. Launched late Nov 2025. 0.19% fee (waived on first $5B AUM through May 31, 2026). Includes staking.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "Launched on NYSE Arca as MSOL on Jul 28, 2026. 0.14% expense ratio (cheapest US SOL ETF). Staking up to 100% via Figment, Galaxy Digital, Coinbase Canada. Dual custody: BNY Mellon (primary) + Coinbase. 5% staking commission to providers; 95% to fund. Monthly distributions. Tracks CoinDesk Solana Benchmark 4PM NY Settlement Rate.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-30",
        "notes": "Live on Cboe BZX as QSOL. Inception Dec 15, 2025. 0.25% expense ratio. Tracks Lukka Prime Solana Reference Rate. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
