...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1/A filed. Withdrew registration statement (Form RW) on Nov 28, 2025 — no shares sold. CoinShares cited dominance of TradFi giants in US crypto ETF market; pivoting to Nasdaq listing via $1.2B SPAC merger with Vine Hill Capital.",
    },
    {
