...
FILINGS = [
    {
        ...
        "notes": "Launched Dec 3, 2025 on NYSE Arca as SOEZ. 0.19% management fee (waived on first $5B AUM through May 31, 2026). Tracks CF Benchmarks Solana Index. Up to 100% staked. NOTE: SOEZ is missing from the ETFS table and should be added.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A amendment filed Jun 18 – Jul 14, 2026: ticker MSOL on NYSE Arca, 0.14% annual sponsor fee (lowest in US crypto ETF market), 100% staked via Figment/Galaxy/Coinbase Canada (5% to providers, 95% to shareholders). Launch nearing per analysts.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "WITHDRAWN. Form RW filed Nov 28, 2025. CoinShares simultaneously withdrew XRP, Solana, and Litecoin US ETF applications. Cited strategic shift and US market consolidation. CoinShares retains European ETP business.",
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-18",
        "notes": "Launched Dec 15, 2025 on Cboe BZX as QSOL. Coinbase custody. Partnership with Galaxy. Seeks to stake substantially all SOL (Lukka Prime benchmark). NOTE: QSOL is missing from the ETFS table and should be added.",
    },
    {
        "issuer": "Osprey Funds",
    ...
    },
    {
        ...
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq filed 19b-4 rule change Mar 10, 2026. SEC issued Order Instituting Proceedings (OIP) Jun 23, 2026 (File No. SR-NASDAQ-2026-016), extending review timeline. Planned listing on Nasdaq.",
    },
]
