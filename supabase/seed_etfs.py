...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on NYSE Arca. 0.19% management fee (waived on first $5B through May 31, 2026). Includes staking (up to 100% of holdings). Tracks CF Benchmarks Solana Index.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A amendment filed Jun 18, 2026: confirmed ticker MSOL, 0.14% annual sponsor fee (lowest in US crypto ETF market), staking included (Figment/Galaxy/Coinbase Canada; 5% to providers, 95% to fund shareholders). Proposed listing NYSE Arca.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-11",
        "notes": "S-1 filed. Launched Dec 15, 2025 on Cboe BZX as QSOL. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
