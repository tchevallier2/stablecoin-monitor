...
# ── Live ETFs (data sourced from issuer sites, Jun 22 2026) ──────────
...
ETFS = [
    ...
    },
    {
        ...
        "gross_yield": "~7.0%",
        "net_yield": "~5.70%",
        "description": "Launched Nov 18, 2025. Management fee 0.25%; staking commission 15%. Both were waived through May 18, 2026 (expired). % staked not publicly disclosed.",
    },
    {
        "ticker": "VSOL",
        "issuer": "VanEck",
    ...
    },
    {
        ...
        "commission_target": "0%",
        "commission_note": "No staking commission; 100% of rewards passed to investors. Marinade Select staking.",
        "pct_staked": "~100%",
        "gross_yield": "~7.0%",
        "net_yield": "~6.5%",
        "description": "Launched Nov 18, 2025. Full name: Canary Marinade Solana ETF. No staking commission; 100% of staking rewards accrued to NAV. Marinade Select staking (SOC 2). BitGo custody.",
    },
    {
        "ticker": "SSK",
        "issuer": "REX-Osprey",
    ...
    },
    {
        ...
        "gross_yield": "~7.0%",
        "net_yield": "N/A",
        "description": "Launched Dec 3, 2025. Lowest expense ratio among Solana ETFs at 0.19%. Stakes up to 100% of SOL. Fee waiver on first $5B expired May 31, 2026. Coinbase custody.",
    },
    {
        "ticker": "QSOL",
        ...
        "gross_yield": "N/A",
        "net_yield": "N/A",
        "description": "Launched Dec 15, 2025. 0.25% expense ratio. Stakes substantially all SOL via Galaxy Digital Infrastructure. Coinbase custody. Lukka Prime Solana reference rate.",
    },
]
...
FILINGS = [
    {
        ...
        "notes": "Launched Dec 3, 2025 on NYSE Arca. 0.19% expense ratio (lowest among Solana ETFs). Stakes up to 100% of SOL. Fee waiver on first $5B expired May 31, 2026.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-06-22",
        "notes": "S-1 filed Jun 2025. Also has live leveraged futures ETF (SLON). No approval announcement found as of Jun 2026.",
    },
    {
        "issuer": "REX-Osprey",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026; S-1/A filed Jun 18, 2026. Proposed ticker MSOL on NYSE Arca. 0.14% fee (lowest in market). Staking via Figment, Galaxy, Coinbase Canada. Still pending SEC approval.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "S-1/A filed. Planned listing on Nasdaq. Coinbase & BitGo custody. No approval announcement found as of Jun 2026.",
    },
    {
        "issuer": "Invesco Galaxy",
        ...
        "is_new": True,
        "last_verified": "2026-06-22",
        "notes": "Launched Dec 15, 2025 on Cboe BZX as QSOL. 0.25% expense ratio. Stakes substantially all SOL via Galaxy Digital Infrastructure. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
        ...
        "is_new": True,
        "last_verified": "2026-06-22",
        "notes": "S-1 filed Oct 2025. Proposed ticker OSOL on Cboe BZX. Coinbase custody. Separate from REX-Osprey joint filing (SSK). No approval announcement found as of Jun 2026.",
    },
    {
        "issuer": "VanEck",
        ...
        "is_new": True,
        "last_verified": "2026-06-22",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq filed SR-NASDAQ-2026-010 in Mar 2026; SEC in 45-day review window. Still pending as of Jun 2026.",
    },
]
