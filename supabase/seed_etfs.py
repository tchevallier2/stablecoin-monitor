...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on NYSE Arca as SOEZ. 0.19% expense ratio (waived on first $5B AUM through May 31, 2026). Includes staking.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1/A filed. Planned listing on Nasdaq. Coinbase & BitGo custody. Withdrew registration Nov 28, 2025; structuring deal for staked SOL ETF never completed. CoinShares cited limited differentiation vs BlackRock/Fidelity/Grayscale.",
    },
    {
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-04-10",
        "notes": "Futures-based Solana ETF (CME SOL futures). Launched Mar 20, 2025 on Nasdaq. 0.95% expense ratio (waived portion through Jun 30, 2026; full rate 1.15% thereafter). Does not hold spot SOL. Series of Volatility Shares Trust.",
    },
    {
        "issuer": "Volatility Shares",
        ...
        "is_new": True,
        "last_verified": "2026-04-10",
        "notes": "2x leveraged daily futures-based Solana ETF (CME SOL futures). Launched Mar 20, 2025 on Nasdaq. 1.85% expense ratio. Seeks twice the single-day return of Solana. Series of Volatility Shares Trust.",
    },
    {
        "issuer": "Roundhill",
        ...
        "is_new": True,
        "last_verified": "2026-04-10",
        "notes": "Synthetic covered call strategy ETF providing income + SOL price exposure via options on Solana ETFs. 485APOS filed Oct 17, 2025 as series of Roundhill ETF Trust. Exchange not yet confirmed at time of filing. Primary objective: current income.",
    },
]
