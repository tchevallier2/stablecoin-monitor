...
FILINGS = [
    ...
    },
    {
        ...
        "sec_url": "https://www.sec.gov/Archives/edgar/data/0002103547/000110465926075843/tm2534148d4_s1a.htm",
        "notes": "S-1 filed Jan 6, 2026 via E*TRADE Capital Management. S-1/A (Amendment 2) filed Jun 18, 2026 — proposed ticker MSOL on NYSE Arca, 0.14% sponsor fee (record-low globally), stakes up to 100% of holdings (trust retains 95% of staking rewards).",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "S-1 filed Jun 16, 2025 (staked Solana ETF). Withdrew via Form RW on Nov 28, 2025 — underlying asset purchase transaction was not completed and no securities were sold.",
    },
    {
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-07-03",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq filed 19b-4 Mar 10, 2026. SEC published notice Mar 20, 2026. SEC instituted OIP proceedings Jun 23, 2026 — public comment deadline Jul 14, 2026 (extended review, approval uncertain).",
    },
]
