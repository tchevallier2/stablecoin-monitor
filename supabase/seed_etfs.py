...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on NYSE Arca as SOEZ. 0.19% fee. Fee waiver through May 31, 2026 on first $5B AUM. Includes staking.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 6, 2026 via E*TRADE Capital Management. S-1/A amendment filed Jun 18, 2026 revealing ticker MSOL on NYSE Arca, 0.14% fee (lowest in market). Staking via Figment, Galaxy Blockchain Infrastructure, Coinbase Canada.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "S-1/A filed Sep 2025. Planned listing on Nasdaq. Coinbase & BitGo custody. Withdrew filing Nov 28, 2025 (Form RW) — firm pivoting away from U.S. single-asset crypto ETFs ahead of planned Nasdaq listing.",
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-06-22",
        "notes": "Launched Dec 15, 2025 on Cboe BZX as QSOL. 0.25% expense ratio. Staking via Galaxy. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
