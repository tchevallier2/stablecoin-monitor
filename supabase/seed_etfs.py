...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A amended May 20 2026 with detailed staking plan. Proposed ticker MSOL on NYSE Arca. Up to 100% of SOL may be staked; rewards distributed monthly. Custodians: BNY Mellon and Coinbase Custody.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-06-08",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq filed 19b-4 rule change to list shares on Mar 10 2026 (Nasdaq Rule 5711(d)); SEC review pending.",
    },
]
