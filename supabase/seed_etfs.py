...
ETFS = [
    ...
    },
    {
        ...
        "fee_waived": False,
        "staking_enabled": True,
        "commission_current": "0% (all passed to investors)",
        "commission_target": "0%",
        "commission_note": "100% of staking rewards passed through to investors; Morgan Stanley retains none",
        "pct_staked": "Up to 100%",
        "gross_yield": "~7.0%",
        "net_yield": "~7.0%",
        "description": "Launched July 28, 2026. Lowest expense ratio (0.14%) among US Solana ETFs. Tracks CoinDesk benchmark. Staking providers: Figment, Galaxy Blockchain, Coinbase Canada. Full rewards passed to investors. Via E*TRADE Capital Management.",
    },
]
...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "Approved and live on NYSE Arca as MSOL since Jul 28, 2026. 0.14% fee — lowest among US Solana ETFs. 100% staking rewards passed to investors (Figment, Galaxy Blockchain, Coinbase Canada). Via E*TRADE Capital Management.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-08-24",
        "notes": "Approved and live on Cboe BZX as QSOL. Galaxy Digital manages SOL purchases. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
        ...
        "is_new": False,
        "last_verified": "2026-08-24",
        "notes": "Approved and live as OSOL on Cboe BZX. Coinbase custody. Separate from REX-Osprey joint SSK filing.",
    },
    {
        "issuer": "VanEck",
        ...
        "is_new": False,
        "last_verified": "2026-08-24",
        "notes": "LST-based Solana ETF using Jito liquid staking token (JitoSOL). Separate from VSOL spot ETF. Planned listing on Nasdaq. Pending SEC approval as of Aug 2026.",
    },
]
