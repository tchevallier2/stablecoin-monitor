...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026; S-1/A (2nd amendment) filed Jun 18, 2026. Proposed ticker MSOL on NYSE Arca. 0.14% unitary annual fee (lowest in US market). Staking via Figment, Galaxy Infrastructure LLC, Coinbase Canada; 95% of rewards to shareholders. Up to 100% of SOL staked.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "Withdrew registration (Form RW) filed Nov 28, 2025. CEO cited crowded US single-asset ETF market. Plans new equity-based / actively managed US products in 12–18 months.",
    },
    {
