...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 6, 2026 via E*TRADE Capital Management. S-1/A (Amendment No. 1) filed May 20, 2026; proposes NYSE Arca listing under ticker MSOL. Staking up to 100% of SOL holdings via third-party providers. Custody: BNY Mellon + Coinbase Custody.",
    },
    {
        "issuer": "CoinShares",
