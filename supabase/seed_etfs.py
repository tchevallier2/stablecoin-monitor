...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Approved and live on NYSE Arca as SOEZ since Oct 28, 2025. 0.19% fee waived through May 31, 2026 on first $5B AUM. Staking enabled.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-04-17",
        "notes": "S-1 filed. Approved and live on Cboe BZX as QSOL since Dec 15, 2025. 0.25% expense ratio. Tracks spot SOL price (no staking). Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-04-17",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq filed 19b-4 proposed rule change on Mar 10, 2026 (Federal Register Mar 20, 2026); SEC review pending as of Apr 2026.",
    },
]
