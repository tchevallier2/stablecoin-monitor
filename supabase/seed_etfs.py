...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Includes staking. Live on NYSE Arca as SOEZ. 0.19% fee (waived on first $5B AUM through May 31, 2026). Coinbase Custody. BNY Mellon administrator.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-06-09",
        "notes": "Live on Cboe BZX as QSOL. Inception Dec 15, 2025. 0.25% expense ratio. Tracks Lukka Prime Solana Reference Rate. Stakes substantially all SOL. Coinbase custody.",
    },
    {
        "issuer": "Osprey Funds",
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-06-09",
        "notes": "Two inverse Solana ETFs added as new ProShares Trust series via 485APOS/485BPOS (Jan 2025). ProShares Short Solana ETF (-1x daily SOL, launched Apr 20, 2026) and ProShares UltraShort Solana ETF (-2x daily SOL, launched May 18, 2026; LEI: 529900TNJD7QXIJTOR02). Derivatives-based via futures/swaps; no direct SOL holding. Tickers unconfirmed. Separate from spot S-1 (Jun 2025).",
    },
]
