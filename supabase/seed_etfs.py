...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A #2 filed Jun 18, 2026: ticker MSOL confirmed, 0.14% sponsor fee (lowest in market), NYSE Arca listing, staking with 95% pass-through (Figment, Galaxy Blockchain Infrastructure, Coinbase Canada as staking providers).",
    },
    {
        "issuer": "CoinShares",
