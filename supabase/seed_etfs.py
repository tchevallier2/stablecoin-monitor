...
FILINGS = [
    {
        ...
        "notes": "S-1 filed Mar 2025. Launched Dec 3, 2025 on NYSE Arca as SOEZ. 0.19% fee (waived on first $5B until May 31, 2026). Coinbase custody. Staking up to 100% of holdings.",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "is_new": True,
        "last_verified": "2026-04-28",
        "notes": "Nasdaq filed 19b-4 on Mar 10, 2026 to list VanEck JitoSOL ETF (Federal Register 2026-05475, published Mar 20). SEC has 45–90 days to approve. First liquid staking token ETF to enter SEC exchange review. Fund holds JitoSOL; rewards compound into NAV rather than distributing separately.",
    },
]
