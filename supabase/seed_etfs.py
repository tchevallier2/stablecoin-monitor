...
FILINGS = [
    {
        ...
        "notes": "Launched Dec 3, 2025 on NYSE Arca as SOEZ. 0.19% expense ratio; fees waived on first $5B AUM through May 31, 2026. Includes staking (up to 100% of holdings).",
    },
    {
        "issuer": "WisdomTree",
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A filed Jun 18, 2026 confirming ticker MSOL on NYSE Arca, 0.14% expense ratio (lowest among US competitors). Includes staking.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-06-27",
        "notes": "Launched Dec 15, 2025 on Cboe BZX as QSOL. Galaxy Digital Infrastructure staking. Coinbase Custody. Lukka Prime SOL Reference Rate. Staking rewards treated as trust income.",
    },
    {
        "issuer": "Osprey Funds",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-06-27",
        "notes": "LST-based Solana ETF holding JitoSOL liquid staking token (not spot SOL). Nasdaq 19b-4 filed Feb 27, 2026. SEC instituted proceedings Jun 23, 2026 (active review, no approval yet). Separate from VSOL spot ETF.",
    },
]
