...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026. S-1/A amendment filed Jun 18, 2026 reveals ticker MSOL, 0.14% fee (market low), staking via Figment/Galaxy Blockchain/Coinbase Canada. Target listing NYSE Arca.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-07-12",
        "notes": "LST-based Solana ETF using Jito liquid staking token. Separate from VSOL spot ETF. Nasdaq 19b-4 rule change filed Mar 10, 2026; SEC published notice Mar 20, 2026. OIP proceedings instituted Jun 23, 2026; public comment deadline Jul 14, 2026.",
    },
]
