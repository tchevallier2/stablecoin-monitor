...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. Amended Jun 2026 with 0.14% fee (record low). Proposed ticker MSOL. Staking via Figment, Galaxy Blockchain Infrastructure, and Coinbase Canada.",
    },
    {
        "issuer": "CoinShares",
        ...
        "notes": "S-1/A filed. Withdrawn Nov 28, 2025 via Form RW. CoinShares cited failed underlying asset purchase deal and strategic pivot to US public listing via SPAC merger with Vine Hill Capital.",
    },
    {
