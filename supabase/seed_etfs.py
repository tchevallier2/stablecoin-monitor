...
FILINGS = [
    ...
    },
    {
        ...
        "notes": "S-1 filed Jan 2026 via E*TRADE Capital Management. S-1/A (2nd amendment) filed Jun 18, 2026 confirming ticker MSOL on NYSE Arca, 0.14% sponsor fee (lowest in market), staking with 95% of rewards returned to investors.",
    },
    {
        "issuer": "CoinShares",
    ...
    },
    {
        ...
        "is_new": False,
        "last_verified": "2026-06-26",
        "notes": "Launched Dec 15, 2025 on Cboe BZX as QSOL. Joint product with Galaxy Asset Management. SEC Form 10-Q filed for period ending Mar 31, 2026 confirms active trading.",
    },
    {
        "issuer": "Osprey Funds",
        ...
        "is_new": False,
        "last_verified": "2026-06-26",
        "notes": "S-1 filed for ETF conversion/listing on Cboe BZX. Coinbase custody. Separate from REX-Osprey joint filing (SSK). OTC trust OSOL has traded since 2021; this filing is for the regulated exchange-listed ETF.",
    },
    {
        "issuer": "VanEck",
        ...
        "is_new": False,
        "last_verified": "2026-06-26",
        "notes": "LST-based Solana ETF holding JitoSOL liquid staking token (SOL price + staking yield + MEV tips). Separate from VSOL spot ETF. Nasdaq filed 19b-4 rule change; SEC review underway as of Apr 2026. Would be first US regulated equities product tied to a liquid staking token.",
    },
]
